...
const SimplePieChart = ({ percentage }: { percentage: number }) => {
  const radius = 40; // Diperkecil sedikit agar muat
  const stroke = 8;
  ...
  return (
    <div className="relative flex items-center justify-center w-24 h-24">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <Text size="3" weight="bold" style={{ color: strokeColor }}>
...
export default function DashboardPage() {
  ...
  return (
    // UBAH 1: Gunakan Flex Column dengan tinggi terkalkulasi agar pas di layar
    <div className="flex flex-col h-[calc(100vh-8rem)] gap-3 pb-1">

      {/* Error Alert */}
      {error && (
        <div className="shrink-0 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center justify-between text-xs text-red-700">
      ...
      {/* Header & Date Navigation - shrink-0 agar tidak mengecil */}
      <div className="shrink-0 flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
        <div>
        ...
        <div className="flex items-center gap-1 bg-white p-1 rounded-lg border border-gray-200 shadow-sm">
          ...
          <div className="flex items-center gap-2 px-2 min-w-[130px] justify-center border-x border-gray-100">
      ...
      {/* Statistik Utama - shrink-0 agar tingginya tetap */}
        ...
        <Grid columns={{ initial: "2", md: "4" }} gap="3">
          ...
          <Card className="shadow-sm border border-gray-100 py-2">
            <Flex direction="column" gap="1">
              ...
              <Text size="6" weight="bold" className="text-gray-900 leading-none">{stats.totalPesertaMagang}</Text>
          ...
          <Card className="shadow-sm border border-gray-100 py-2">
            <Flex direction="column" gap="1">
              ...
              <Text size="6" weight="bold" className="text-gray-900 leading-none">{stats.pesertaMagangAktif}</Text>
      ...
      {/* Konten Fleksibel: Chart & Activity - Mengisi sisa ruang */}
      <div className="flex-1 min-h-0">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 h-full">

          {/* Kolom Kiri: Tingkat Kehadiran */}
          <div className="md:col-span-1 h-full">
            <Card className="shadow-sm border border-gray-100 h-full overflow-hidden flex flex-col">
              <Flex direction="column" p="3" gap="3" className="h-full">
                <Flex align="center" gap="2" className="border-b border-gray-50 pb-2 shrink-0">
                  <BarChart3 className="h-4 w-4 text-gray-500" />
                  <Text weight="bold" size="2">Kehadiran</Text>
                </Flex>

                <Flex direction="column" align="center" justify="center" gap="2" className="flex-1">
                  <SimplePieChart percentage={stats.tingkatKehadiran} />
                  <Text size="1" color="gray" align="center" className="text-[10px] leading-tight max-w-[180px]">
                    {stats.tingkatKehadiran >= 90 ? 'Pertahankan performa ini.' :
                     stats.tingkatKehadiran >= 75 ? 'Cukup Baik.' : 'Perlu ditingkatkan.'}
                  </Text>
                </Flex>

                <div className="space-y-1.5 pt-2 border-t border-gray-100 mt-auto shrink-0">
                  ...
                  <Flex justify="between" align="center">
                    <Flex align="center" gap="2">
                      ...
                      <Text size="1" color="gray">Absen</Text>
                    </Flex>
          ...
          {/* Kolom Kanan: Aktivitas Terbaru - Scroll Internal */}
          <div className="md:col-span-2 h-full">
            <Card className="shadow-sm border border-gray-100 h-full flex flex-col overflow-hidden p-0">
              <Flex justify="between" align="center" p="3" className="border-b border-gray-100 bg-gray-50/50 shrink-0">
                <Flex align="center" gap="2">
              ...
              {/* UBAH 2: flex-1 dan overflow-y-auto di sini agar scroll terjadi di dalam card */}
              <div className="flex-1 overflow-y-auto">
                {stats.aktivitasBaruBaruIni.length > 0 ? (
                  ...
                  <Flex direction="column" align="center" justify="center" className="h-full text-gray-400">
